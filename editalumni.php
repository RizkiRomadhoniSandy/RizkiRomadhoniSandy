        ...
        <form action="<?php $_SERVER["PHP_SELF"];?>" method = "post">
            ...
            <div class="form-group mt-2">
                <div class="row">
                    ...
                    <div class="col">
                        <input type="text" name="tahunlulus" id=tahunlulus class="form-control" value="<?php echo $array["tahunlulus"]; ?>">
                    </div>
                </div>
            </div>
            <div class="form-group mt-2">
                <div class="row">
                    ...
                    <div class="col">
                        <input type="text" name="pekerjaan" id=pekerjaan class="form-control" value="<?php echo $array["pekerjaan"]; ?>">
                    </div>
                </div>
            </div>
            <div class="form-group mt-2">
                <div class="row">
                    ...
                    <div class="col">
                        <textarea name="message" id="message" cols="30" rows="10" class="form-control"><?php echo $array["message"]; ?></textarea>
                    </div>
                </div>
            </div>
